...
одно: без JS браузер правило «хотя бы одно из двух» не проверит.
...
⚠️ **Браузер это правило не стережёт.** «Хотя бы одно из двух» без JS проверить
нечем: форму можно отправить, не заполнив ни серийник, ни чек. Сейчас условие
держится только на словах в подписи. Что с этим делать — в DEPLOY.md.
