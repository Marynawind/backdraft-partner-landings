...
**11.09.2026 условие отменено совсем.** Клиент: «все поля должны иметь
звёздочку» — значит серийный номер И чек обязательны оба, «или» из подписи
убрано. Это строже, чем просил партнёр, зато проверять покупку станет проще:
серийник и чек подтверждают друг друга. ⚠️ Стоит показать партнёру: часть
покупателей не найдёт чек и не дойдёт до конца формы.
