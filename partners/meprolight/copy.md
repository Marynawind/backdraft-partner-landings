...
**Подписи полей:** Full name\* · Email\* · Phone\* · Date of birth\* ·
Serial number · **or** · Proof of purchase

Дата рождения появилась не по просьбе клиента: сервис рассылки SMS не заводит
подписчика без неё, а код рибейта уходит сообщением. Под полем сначала стояла
подсказка «Required by our text message provider» — объяснение, зачем форме на
рибейт дата рождения; клиент её снял, поле осталось без пояснения.
