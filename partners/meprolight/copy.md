...
**Галочка возраста:** I certify that I am 21 years of age or older.
...
Галочка возраста, наоборот, обязательная: без неё форма не отправится. Сначала
в форме было поле даты рождения — его просил сервис рассылки SMS, — но клиент
попросил дату убрать, а подтверждение возраста оставить. Формулировка «I
certify» выбрана намеренно: страница ничей возраст не проверяет и проверить не
может, человек подтверждает его сам. Настоящая проверка документа происходит
у FFL/SOT при передаче глушителя.
