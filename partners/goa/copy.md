...
## 1. Welcome (hero)
**Eyebrow:** Gun Owners of America × Backdraft Suppressors
...
- Логотип GOA на странице? Использование их товарного знака требует письменного
  разрешения партнёра — пока текстовый co-brand lockup.
