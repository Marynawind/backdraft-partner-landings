...
NUM_CAP = 32
# Полоса — сноска, поэтому мельче шагов. Заголовок колонки и её текст идут
# ОДНИМ кеглем, отличаются только насыщенностью: заголовки набраны прописными
# и при большем кегле смотрелись тяжелее текста под ними.
STRIP_CAP, STRIP_LEAD = 14, 21
ICON_H = 48
