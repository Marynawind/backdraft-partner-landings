...
- Логотип Master FFL взят с masterffl.com, светлая версия. Использование
  товарного знака партнёра требует его разрешения — подтвердить у клиента.
  Использование товарного знака партнёра согласовывает клиент — вопрос
  закрыт с его стороны, не техническая часть.
- Есть ли отдельный эксклюзивный код для клиентов MasterFFL, который нужно показать?
- Нужна ли форма сбора e-mail клиентов MasterFFL?
